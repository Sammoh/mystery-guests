...
#pragma warning restore 4014
        ...
        {
            Debug.LogError($"Starting networkClient @ {ip}:{port}\nWith : {User}");
        ...
        {
            var sceneName = ClientSingleton.Instance.loadSceneName;
        ...
        async Task<MatchmakerPollingResult> GetMatchAsync()
        {
            ...
            Debug.LogError($"Matchmaking Result: {matchmakingResult.resultMessage}");
            Debug.LogError($"Matchmaking Server: {matchmakingResult.ip}:{matchmakingResult.port}");
