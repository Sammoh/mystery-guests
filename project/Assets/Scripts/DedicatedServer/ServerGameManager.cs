...
namespace Matchplay.Server
{
    public class ServerGameManager : IDisposable
    {
        ...
        {
            Debug.LogError($"Starting server with:{startingGameInfo}.");
            ...
            try
            {
                ...
                {
                    Debug.LogError($"Got payload: {matchmakerPayload}");
        ...
        {
            // Sammoh - TODO Set the servers password to easily connect again.
        ...
        {
            Debug.LogError($"{joinedUser} joined the game");
