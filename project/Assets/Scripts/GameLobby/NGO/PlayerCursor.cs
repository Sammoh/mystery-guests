...
namespace LobbyRelaySample.ngo
{
    ...
    public class PlayerCursor : NetworkBehaviour
    {
        ...
        // need to be able to get a minigame to subscribe to the minigame start event. 
        ...
        private bool IsSelectInputHit()
        {
            ...
            // ask the minigame if the input was valid?
        }
        ...
        public void Update()
        {
            ...
            // only the host should be able to send the input.
