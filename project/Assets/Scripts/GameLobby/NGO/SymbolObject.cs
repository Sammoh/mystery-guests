...
{
    /// <summary>
    /// This holds the logic and data for an individual symbolIndex
    /// which can be "clicked" if the server detects the collision with a player who sends a click input.
    /// When used in the minigame scene, this is used for any interaction that requires a player to click.
    /// </summary>
    public class SymbolObject : NetworkBehaviour
    {
        ...
        // this would be set by the minigame manager.
