...
namespace LobbyRelaySample.UI
{
    ...
    public class ColorLobbyUI : MonoBehaviour
    {
        ...
        public void ToggleWhite(bool toggle)
        {
            if (!toggle)
                return;
            GameManager.Instance.SetLocalLobbyColor(LobbyColor.None);
        }
        ...
        public void ToggleOrange(bool toggle)
        {
            if (!toggle)
                return;
            GameManager.Instance.SetLocalLobbyColor(LobbyColor.Orange);
        }
        ...
        public void ToggleGreen(bool toggle)
        {
            if (!toggle)
                return;
            GameManager.Instance.SetLocalLobbyColor(LobbyColor.Green);
        }
        ...
        public void ToggleBlue(bool toggle)
        {
            if (!toggle)
                return;
            GameManager.Instance.SetLocalLobbyColor(LobbyColor.Blue);
        }
