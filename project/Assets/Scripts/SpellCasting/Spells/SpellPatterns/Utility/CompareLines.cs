...
{
    public static float DifferenceBetweenLines(Vector3[] drawn, Vector3[] toMatch) {
        float sqrDistAcc = 0f;
        float length = 0f;
    ...
    /// </summary>
    static IEnumerable<Vector3> WalkAlongLine(IEnumerable<Vector3> line, float maxStep = .25f) {
